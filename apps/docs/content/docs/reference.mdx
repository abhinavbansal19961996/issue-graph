...
All runtime examples use the installed `issue-graph` command. Today that means an authorized [source installation](/docs/get-started), not the public npm placeholder.
